...
import 'package:fluttermic/provider/usuario_provider.dart';
import 'package:fluttermic/shapes/dibujarCurva0.dart';
import 'package:fluttermic/utils/utils.dart';
  ...
  Widget _crearFondo(BuildContext context) {
    ...
    return Stack(
      children: <Widget>[
        fondoAzul,
        Container(
          padding: EdgeInsets.symmetric(horizontal: 150.0, vertical: 45.0),
          child: SafeArea(
            child: Column(
              children: <Widget>[
                SafeArea(
